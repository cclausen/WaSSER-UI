...
export class PersonControllerService {
  ...
  public create(
    ...
    return this.httpClient.request<Person>(
      'post',
  ...
  public deletePerson(
    ...
    let localVarPath = `/api/persons/${this.configuration.encodeParam({
      name: 'personId',
      value: personId,
      in: 'path',
      style: 'simple',
  ...
  public indexPersons(
    ...
    let localVarPath = `/api/persons/`;
    return this.httpClient.request<Array<Person>>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  public update(
    ...
    if (personId === null || personId === undefined) {
      throw new Error(
        'Required parameter personId was null or undefined when calling update.'
      );
    }
    if (person === null || person === undefined) {
      throw new Error(
